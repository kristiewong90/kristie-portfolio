...
@section('content')
  ...
  <div class="about-box container">
    ...
    <div class="row">
      <div class="skills-textbox col-md-12">
        <div class="row">

          <div class="user icons col-md-4">
          ...
          <div class="bike icons col-md-4">
            <img src="/img/bicycle.gif" alt="Bicycle Icon">
